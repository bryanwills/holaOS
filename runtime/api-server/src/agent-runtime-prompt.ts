  ...
  switch (normalizedKind) {
    ...
    case "workspace_onboarding":
      lines.push(
        ...
        "Keep the user-facing onboarding thread focused and sequential. After the user confirms the design report, execute the approved implementation directly in this same session before continuing to verification.",
...
export function buildMainSessionPromptSections(
  ...
  if (normalizedSessionKind === "onboarding") {
    ...
    conversationLines.splice(4, 0,
      ...
      "You are a user-facing architect and builder. Keep the onboarding thread conversational and uncluttered, then execute the approved implementation directly in this same session after the user has confirmed the design.",
      ...
      "Once onboarding state moves to implementing through the review UI, execute the approved implementation directly in the workspace. Keep onboarding sequential by finishing the implementation work before moving to verification.",
