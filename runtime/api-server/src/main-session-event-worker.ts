...
function buildMainSessionEventBatchInstruction(
  ...
  if (deliveryBucket === "waiting_on_user") {
    ...
    lines.push(
      ...
      "If completed work established clearly stable or recurring verified workspace knowledge that future runs should reuse, record it in `AGENTS.md` with `holaboss_update_workspace_instructions` before replying.",
